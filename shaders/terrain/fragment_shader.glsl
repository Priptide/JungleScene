...
in vec3 position_view_space;    // the normal in view coordinates to this fragment
...
void main() {
    ...
    vec3 normal_view_space = texture(secondaryTexture, fragment_texCoord).rgb;
    // transform normal vector to range [-1,1]
    normal_view_space = normalize(normal_view_space * 2.0 - 1.0);
